...
.SYNOPSIS
    AtGitHub Repos Page
.DESCRIPTION
    Generates a list of repositories mentioned on AtGitHub.
.LINK
    https://AtGitHub.com/Repos
#>
...
$repoSummary = $repoSummary | Sort-Object -Property Score -Descending
