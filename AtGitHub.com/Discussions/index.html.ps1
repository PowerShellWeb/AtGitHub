<#
.SYNOPSIS
    AtGitHub Discussions
.DESCRIPTION
    Generates a table of discussions from the AtGitHub site.
.LINK
    https://AtGitHub.com/Discussions    
#>
...
$Title = "Discussions"
$Description = "GitHub Discussions mentioned in BlueSky"
